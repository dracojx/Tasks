...
class BootStrap {
	...
	def init = { servletContext ->
		...
		environments {
			development {
				def admin = new User(username:"admin",password:"123456".encodeAsMD5().encodeAsMD5(), name:"管理员",
