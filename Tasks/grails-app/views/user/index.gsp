...
<html>
	...
	<body>
		...
		<div id="list-user" class="content scaffold-list" role="main">
			<h1><g:message code="default.list.label" args="[entityName]" />(${userInstanceList?.size() ?: 0  })</h1>
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="activate" title="${message(code: 'user.activate.label', default: 'Activate')}" />
