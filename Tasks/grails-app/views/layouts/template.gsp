	...
	<body>
		<div class="top_panel">
			<g:if test="${session?.userId }">
			  <div class="wrapper">
			    <div class="user">
			   		<asset:image src="user_avatar.png" class="user_avatar" alt="user_avatar"/>
			        <span class="label">${User.get(session.userId)?.getName() }</span>
			    </div>
			    <div class="top_links">
			    	<ul>
		...
		<div class="wrapper contents_wrapper">
		  <aside class="sidebar">
		    <ul class="tab_nav">
		      <li class="i_32_dashboard ${!params.controller&&(params.action='index')? 'active_tab':'' }">
		      	<g:link uri="/index" title="${message(code:'overview.summary.label') }">
		        	<span class="tab_label"><g:message code="overview.label"/></span>
		            <span class="tab_info"><g:message code="overview.summary.label"/></span> 
		      	</g:link>
		      </li>
		      <li class="i_32_tasks ${params.controller=='task'? 'active_tab':'' }">
		      	<g:link controller="task" action="index" title="${message(code:'overview.summary.label') }">
